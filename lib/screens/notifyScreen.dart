...
import 'package:hairsalon_prokit/utils/panel.dart';
...
class SlideUpSheetScreenState extends State<NotifyScreen> {
  late List<NotifyModel> notifyList;
          ...
          children: [
            ...
            ListView.separated(
              separatorBuilder: (context, index) =>
                  Divider(color: aappDividerColor),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Icon(Icons.star, size: 14, color: colorPrimary)
                                .paddingOnly(left: 4),
                            8.width,
